...
All scripts are in the folder `/MixedMatern/tests`, and all intermediate and final results are saved in the folder `/results`. Note that it takes a long time for some codes to finish running.
