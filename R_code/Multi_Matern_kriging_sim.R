...
if (platform=='Darwin'){
  dat <- readMat('/Users/minjay/Documents/Documents/Research/div_curl/MixedMatern/tests/sim/prediction/sim_data_mix.mat')
}else if (platform=='Linux'){
  dat <- readMat('/home/minjay/div_curl/MixedMatern/tests/sim/prediction/sim_data_mix.mat')
}
...
rec.pred.loc <- dat$rec.pred.loc
rec.est.loc <- dat$rec.est.loc
...
param.BM <- mclapply(1:B, fit.model, mc.cores = 24)
