...
true_values = [1 1 0.5 3 4 1/2 0.1 0.1  5 5 -10 10 -15 20];

for i = 1:14
    subplot(3, 5, i)
    if i==6
        myboxplot([1./rec_beta_hat1(:,i) 1./rec_beta_hat2(:,i) 1./rec_beta_hat3(:,i)], lab_cell, 0.4)
    else
        myboxplot([rec_beta_hat1(:, i) rec_beta_hat2(:, i) rec_beta_hat3(:, i)], lab_cell, 0.4)
    end
